...
<body>
    ...
    <div class="m-5 p-5 overflow-hidden shadow-sm sm:rounded-lg list">
        <form action="<?php echo e(route('add-coupon')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
</html><?php /**PATH D:\emergency\Laravel\shop\resources\views/new-coupon.blade.php ENDPATH**/ ?>